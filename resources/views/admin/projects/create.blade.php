    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card mb-4" style="background: rgba(0,255,65,0.05); border: 1px solid var(--primary-glow); border-left: 5px solid var(--primary-glow);">
                <div class="card-body">
                    <h2 style="color: var(--primary-glow); margin: 0; text-transform: uppercase; letter-spacing: 2px;">➕ Tambah Project Baru</h2>
                    <p style="color: #888; margin: 5px 0 0 0;">Isi form di bawah untuk menambah project ke portfolio</p>
                </div>
            </div>
