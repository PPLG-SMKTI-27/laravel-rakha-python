        ...
        <div class="col-12 col-md-10 col-lg-8">
            ...
            <div class="card mb-4" style="background: rgba(0,255,65,0.05); border: 1px solid var(--primary-glow); border-left: 5px solid var(--primary-glow);">
                <div class="card-body p-3 p-md-4">
                    <h2 style="color: var(--primary-glow); margin: 0; text-transform: uppercase; letter-spacing: 2px; font-size: 1.3rem;" class="d-md-h2">➕ Tambah Project Baru</h2>
                    <p style="color: #888; margin: 5px 0 0 0; font-size: 0.9rem;">Isi form di bawah untuk menambah project ke portfolio</p>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-md-4">
                    <form action="{{ route('admin.projects.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 flex-column flex-sm-row">
                            <button type="submit" class="btn btn-success flex-grow-1">✅ Tambah Project</button>
                            <a href="{{ route('admin.projects.index') }}" class="btn btn-secondary flex-grow-1">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
